...
export const Navigation = () => {
  ...
  const handleCloseCreateEmployerModal = () =>
    setOpenCreateEmployerModal(false);
  ...
  return (
    <div className="h-screen sticky overflowY top-0">
          ...
          {navigation.map((item, index) => (
            ...
            >
              ...
              auth.user.userType === "jobSeeker" ? (
                ...
                item.title !== "employerProfile" &&
                item.title !== "companyProfile" &&
                auth.user.userType === "jobSeeker" ? (
                <>
                  {item.icon}
                  <p className="text-xl">{item.title}</p>
      ...
      >
        ...
        <div>
          <Button id="basic-button" onClick={handleOpenConfirmMessage}>
            LOGOUT
          </Button>
        </div>
      </div>
      ...
      <section>
        <CreateEmployerModal
          openCreateEmployerModal={openCreateEmployerModal}
          handleCloseCreateEmployerModal={handleCloseCreateEmployerModal}
        />
      </section>

      <section>
        <CreateFieldModal
          openCreateFieldModal={openCreateFieldModal}
          handleCloseCreateFieldModal={handleCloseCreateFieldModal}
        />
      </section>
      ...
      <section>
        <ConfirmMessage
          ...
          response={"Do you want to signout ? "}
          Title={"LOGOUT"}
      ...
      <section>
        <GiveEmployerFields
          openGiveEmployerFields={openGiveEmployerFields}
          handleCloseGiveEmployerFields={handleCloseGiveEmployerFields}
        />
      </section>
    </div>
  );
