    ...
    <div>
      <section className={`z-50 flex items-center sticky top-0 bg-opacity-95`}>
        ...
        <h1 className="py-5 text-xl font-bold opacity-90 ml-5">
          {jobSeekerData !== null && jobSeekerData.userName}
        </h1>
      </section>
      ...
      <section className="pl-6">
        <div className="flex justify-between items-start mt-5 h-[5rem]">
          ...
          />
          {jobSeekerData !== null && jobSeekerData.req_user ? (
            <Button
            ...
            <Button
              ...
              sx={{ borderRadius: "20px" }}
            >
              {jobSeekerData !== null && jobSeekerData.followed
                ? "Unfollow"
                : "follow"}
            </Button>
          )}
        ...
        <div>
          <div className="flex item-center">
            ...
            <div className="flex items-center space-x-20">
              <div className="ml-10 flex items-center space-x-1 font-semibold">
                <span>
                  {jobSeekerData !== null && jobSeekerData.followers.length > 0
                    ? jobSeekerData.followers.length
                    : 0}
                </span>
              ...
              <div className="flex items-center space-x-1 font-semibold">
                <span>
                  {jobSeekerData !== null && jobSeekerData.followings.length > 0
                    ? jobSeekerData.followings.length
                    : 0}
                </span>
          ...
          <p className="text-gray-500">
            {jobSeekerData !== null && jobSeekerData.email}
          </p>
        </div>
            ...
            <div className="flex space-x-5 cursor-pointer">
              ...
              <div className="flex items-center text-gray-500">
                ...
                <p className="ml-2 mt-3">
                  {jobSeekerData !== null && jobSeekerData.address}
                </p>
              </div>
      ...
      <section>
        <MessageModal
          openMessageModal={openEductationModal}
          handleCloseMessageModal={handleCloseEducationModal}
          response={jobSeekerData !== null && jobSeekerData.education}
          Title={"Education"}
          state={true}
        />
      </section>
