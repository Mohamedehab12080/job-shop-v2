...
export default function AuthModal({ openAuthModal, handleClose }) {
  ...
  return (
    <div>
      ...
      >
        <Box sx={style}>
          <div className="items-center" style={contentStyle}>
            {" "}
            {/* Wrap the content inside a div with fixed height and overflow */}
            <h1 className="text-2xl py-9 text-center">
