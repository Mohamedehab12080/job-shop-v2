...
import {
  registerJobSeekerUser,
  registrerCompanyUser,
          ...
          >
            {locations &&
              locations.map((location, index) => (
                <MenuItem key={index} value={location} onClick={handleOther}>
                  {location}
                </MenuItem>
              ))}
          </TextField>
          ...
          <Grid item xs={12} key={index}>
            <TextField
              ...
              error={
                ...
                Boolean(formik.errors.contacts && formik.errors.contacts[index])
              }
              helperText={
                formik.touched.contacts &&
