        ...
        <Grid item className='px-10' lg={5} xs={12}>
          ...
          <div className='w-[60%]'>
            <div className='w-full'>
              ...
              <Button fullWidth onClick={handleOpenAuthModal} variant="contained" size="large" sx={{
                borderRadius:"29px",
                py:"7px",
            ...
            <div className='mt-5'>
              ...
              <Button fullWidth onClick={handleOpenAuthModal} variant="outlined" size="large" sx={{
                borderRadius:"29px",
                py:"7px"
              }}>LOGIN</Button>
            </div>
