...
export default function CreateEmployerModal({
  openCreateEmployerModal,
  handleCloseCreateEmployerModal,
}) {
  ...
  const handleSubmit = async (values) => {
    ...
    setEmployerEmailToShow(values.email);
    setCreateState(true);
    formik.resetForm();
    setSelectedField([]);
    setOpenShowEmployerModal(true);
  };
  ...
  const formik = useFormik({
    initialValues: {
      ...
      address: "",
      gender: "",
      employerFields: [{ companyFieldId: 0 }],
    },
          ...
          <Box sx={style}>
            ...
            <form onSubmit={formik.handleSubmit}>
              <Grid container direction="column" spacing={2}>
                ...
                <Grid item xs={12}>
                  <div
                    className="skills-scroll-container sapce-y-2"
            ...
            <section>
              <ShowEmployerModal
                ...
                handleCloseShowEmployerModal={handleCloseShowEmployerModal}
                create={createState}
                employerEmail={employerEmailToShow}
              />
            </section>
          </Box>
        </Slide>
