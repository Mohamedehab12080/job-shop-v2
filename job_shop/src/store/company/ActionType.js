...
export const GET_COMPANY_INFO_SUCCCESS='GET_COMPANY_INFO_SUCCESS'
...
export const UPDATE_COMPANY_INFO_SUCCCESS='UPDATE_COMPANY_INFO_SUCCESS'
export const UPDATE_COMPANY_INFO_FAILURE='UPDATE_COMPANY_INFO_FAILURE'

export const UPDATE_COMPANY_CONTACTS_REQUEST='UPDATE_COMPANY_INFO_REQUEST'
export const UPDATE_COMPANY_CONTACTS_SUCCCESS='UPDATE_COMPANY_INFO_SUCCESS'
export const UPDATE_COMPANY_CONTACTS_FAILURE='UPDATE_COMPANY_INFO_FAILURE'

export const GIVE_EMPLOYER_FIELDS_REQUEST='GIVE_EMPLOYER_FIELDS_REQUEST'
export const GIVE_EMPLOYER_FIELDS_SUCCCESS='GIVE_EMPLOYER_FIELDS_SUCCESS'
export const GIVE_EMPLOYER_FIELDS_FAILURE='GIVE_EMPLOYER_FIELDS_FAILURE' 

export const DELETE_FIELD_REQUEST='DELETE_FIELD_REQUEST'
export const DELETE_FIELD_SUCCCESS='DELETE_FIELD_SUCCESS'
