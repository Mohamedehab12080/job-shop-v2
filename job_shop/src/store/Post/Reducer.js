...
import { ACCEPT_APPLICATION_FAILURE, ACCEPT_APPLICATION_REQUEST, 
    ACCEPT_APPLICATION_SUCCESS, CREATE_POST_FAILURE, CREATE_POST_REQUEST, CREATE_POST_SUCCESS,DELETE_APPLICATION_FAILURE,
    DELETE_APPLICATION_REQUEST,DELETE_APPLICATION_SUCCESS,DELETE_POST_FAILURE,DELETE_POST_REQUEST,DELETE_POST_SUCCESS,
    FETCH_COMPANY_POSTS_FAILURE,FETCH_COMPANY_POSTS_REQUEST,FETCH_COMPANY_POSTS_SUCCESS,FETCH_EMPLOYER_POSTS_FAILURE,
    FETCH_EMPLOYER_POSTS_REQUEST,FETCH_EMPLOYER_POSTS_SUCCESS,FETCH_MATCHED_POSTS_FAILURE, FETCH_MATCHED_POSTS_REQUEST,
     FETCH_MATCHED_POSTS_SUCCESS, FETCH_MATCHED_SEARCH_POSTS_FAILURE, FETCH_MATCHED_SEARCH_POSTS_REQUEST,
      FETCH_MATCHED_SEARCH_POSTS_SUCCESS, FETCH_POST_APPLICATIONS_FAILURE, FETCH_POST_APPLICATIONS_REQUEST,
       FETCH_POST_APPLICATIONS_SUCCESS, FIND_POST_BY_ID_FAILURE, FIND_POST_BY_ID_REQUEST, FIND_POST_BY_ID_SUCCESS,
       MAKE_APPLICATION_FAILURE, MAKE_APPLICATION_REQUEST, MAKE_APPLICATION_SUCCESS, REJECT_APPLICATION_FAILURE, REJECT_APPLICATION_REQUEST, REJECT_APPLICATION_SUCCESS, SHOW_POSTS_AFTER_APPLY_FAILURE, SHOW_POSTS_AFTER_APPLY_REQUEST, SHOW_POSTS_AFTER_APPLY_SUCCESS, UPDATE_POST_FAILURE, UPDATE_POST_REQUEST, UPDATE_POST_SUCCESS } from "./ActionType"
...
export const postReducer=(state=initialState,action)=>
{
    switch(action.type)
    {
        ...
        case FETCH_MATCHED_SEARCH_POSTS_REQUEST:
        ...
        case FETCH_MATCHED_SEARCH_POSTS_FAILURE:
            return {...state,loading:false,error:action.payload};
        case FETCH_MATCHED_SEARCH_POSTS_SUCCESS:
           if(action.payload)
            {
                return {
                    ...state,
